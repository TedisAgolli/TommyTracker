 ...
 */
class HeaderFragment : HeaderView, Fragment() {



    @Inject lateinit var presenter:HeaderPresenter
    ...
    override fun setWeight(weight: String) {
        header_txt_weight.text = weight
    }

    override fun setHeight(height: String) {
        header_txt_height.text = height
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): HeaderFragment {
